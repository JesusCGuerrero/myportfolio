            ...
            <div className="nav-logo">
                <a href="/#intro">
                    <svg className="svg-logo" width="126" height="221" viewBox="0 0 126 221" fill="none" xmlns="http://www.w3.org/2000/svg">
	                    <path d="M125 16.5C125 25.0604 118.06 32 109.5 32C100.94 32 94 25.0604 94 16.5C94 7.93959 100.94 1 109.5 1C118.06 1 125 7.93959 125 16.5Z" stroke="#2CFFC0" stroke-width="2"/>
